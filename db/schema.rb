...
ActiveRecord::Schema[7.0].define(version: 2024_11_22_183252) do
  ...
  create_table "playlists", force: :cascade do |t|
    ...
    t.index ["uploader_id"], name: "index_playlists_on_uploader_id"
  end
  ...
  add_foreign_key "playlists", "users", column: "uploader_id"
